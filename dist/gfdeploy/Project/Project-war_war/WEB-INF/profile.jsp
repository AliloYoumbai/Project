...
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
	...
	%>
	<%
	ArrayList<Jamiai> jamiai = (ArrayList<Jamiai>) request.getAttribute("jamiai");
	%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<section id="main" class="container">
		<header>
			<h2 style="background-color: #fff">صفحة الرئسية</h2>
		</header>
