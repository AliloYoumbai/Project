								...
								<form method="post" action="Controler">
									<div class="row gtr-uniform gtr-50">
										...
										<div class="col-6 col-12-mobilep">
											<input type="text" name="montant" id="name" value=""
												placeholder=" المبلغ " />
										</div>
										<div class="col-6 col-12-mobilep">
											<label>الوقت</label> <input type="date" name="time" id="name"
												value="" placeholder="الوقت" />
										</div>

										<input type="hidden" name="test" value="amwal" />
